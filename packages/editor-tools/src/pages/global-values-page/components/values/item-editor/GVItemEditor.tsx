...
import { GVButton } from '@/editor-tools/src/pages/global-values-page/components/button/GVButton';
import { GlobalValueItem } from '@/nextjs/types/content-props/global-values-props';
import {
    generateGvUsageMessages,
    gvNameExists,
} from '@/editor-tools/src/pages/global-values-page/utils';
import { gvServiceAddItem } from '@/editor-tools/src/pages/global-values-page/api/services/add';
import { gvServiceModifyItem } from '@/editor-tools/src/pages/global-values-page/api/services/modify';
import { gvServiceRemoveItem } from '@/editor-tools/src/pages/global-values-page/api/services/remove';
import { useGvEditorState } from '@/nextjs/store/hooks/useGvEditorState';
import { gvServiceGetValueSet } from '@/editor-tools/src/pages/global-values-page/api/services/getValueSet';
import { gvServiceGetUsage } from '@/editor-tools/src/pages/global-values-page/api/services/usage';
import { GVMessageProps } from '@/editor-tools/src/pages/global-values-page/components/messages/GVMessages';
import {
