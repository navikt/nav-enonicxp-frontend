...
exports.createXFrameOptionsHeaderValue = (option, strictURIEncoder = shared_1.encodeStrictURI) => {
    if (option == undefined)
        return "deny";
    if (option === false)
        return;
...
exports.createFrameGuardHeader = (option, headerValueCreator = exports.createXFrameOptionsHeaderValue) => {
