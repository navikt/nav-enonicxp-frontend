...
exports.createExpectCTHeaderValue = (option, strictURIEncoder = shared_1.encodeStrictURI) => {
    var _a;
    if (option == undefined)
        return;
    if (option === false)
...
exports.createExpectCTHeader = (option, headerValueCreator = exports.createExpectCTHeaderValue) => {
    if (option == undefined)
        return;
    if (option === false)
        return;
