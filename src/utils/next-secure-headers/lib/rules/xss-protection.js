...
exports.createXXSSProtectionHeaderValue = (option, strictURIEncoder = shared_1.encodeStrictURI) => {
    if (option == undefined)
        return "1";
    if (option === false)
        return "0";
...
exports.createXSSProtectionHeader = (option, headerValueCreator = exports.createXXSSProtectionHeaderValue) => {
